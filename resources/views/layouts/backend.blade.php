...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <link href="{{ asset('/templates/adminlte/plugins/iCheck/all.css') }}" rel="stylesheet" type="text/css">
        <!-- Select2 -->
        <link href="{{ asset('/templates/adminlte/plugins/select2/css/select2.min.css') }}" rel="stylesheet" type="text/css">
        <!-- datetimepicker -->
        ...
        <!-- Custom CSS -->
        <link href="{{ asset('/css/backend.css?version=' . config('app.version')) }}" rel="stylesheet">
    ...
    <body class="hold-transition {{ config('app.theme') }} sidebar-mini">
        @auth
        ...
        <!-- SlimScroll -->
        <script src="{{ asset('/templates/adminlte/plugins/jquery-slimscroll/jquery.slimscroll.min.js') }}"></script>
        <!-- FastClick -->
        <script src="{{ asset('/templates/adminlte/plugins/fastclick/fastclick.js') }}"></script>

        <!-- Plugins -->
        <!-- iCheck for checkboxes and radio inputs -->
        <script src="{{ asset('/templates/adminlte/plugins/iCheck/icheck.min.js') }}" type="text/javascript"></script>
        <!-- Select2 -->
        <script src="{{ asset('/templates/adminlte/plugins/select2/js/select2.min.js') }}" type="text/javascript"></script>
        <!-- Moment Js-->
        ...
        <!-- Custom Js -->
        <script src="{{ asset('/js/backend.js?version=' . config('app.version')) }}"></script>
